    ...
    <section id="home" className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      ...
      <div className="container relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4 relative z-20">
          <a
            href="https://drive.google.com/file/d/1At3ucDvRpoDyDTjZpP1zTbjDtabNxq-W/view?usp=drivesdk"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 border border-white/15 px-6 h-12 rounded-xl bg-gray-900"
          >
